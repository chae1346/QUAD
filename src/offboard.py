...
def main():
    ...
    local_pos_pub = rospy.Publisher("/mavros/setpoint_position/local", PoseStamped, queue_size=10) # MAVROS에 명령 전송
    detection_pub = rospy.Publisher("/start_detection", String, queue_size=10)  # 노트북에 명령 전송
    rospy.sleep(1)
